  ...
  return (
    <div>
      <div className="background-svg">
        <svg xmlns="http://www.w3.org/2000/svg" width="877.073" height="1150.292" viewBox="0 0 877.073 1080.292">
          <g id="Group_7" data-name="Group 7" transform="translate(0.073 0.726)">
            ...
            <g id="Ellipse_1" data-name="Ellipse 1" transform="translate(700 784)" fill="none" stroke="#d35400" stroke-width="9">
      ...
      <Container fluid="true">
        <Row>
          <Col></Col>
          <Col className="text-center sign-up">
            SIGN UP FOR SWURF
          </Col>
        </Row>
      </Container>
